...
public class PasswordEncoder {
    ...
    public static void main(String[] args) {
        ...
        boolean passwordValid = encoderMd5.isPasswordValid("85086fcebce6faddc119b5de391888a6", "test");
        System.out.println(passwordValid);

        PasswordEncoder encoderSha = new PasswordEncoder(salt, "SHA");
        String pass2 = encoderSha.encode("test");
        System.out.println(pass2);
        boolean passwordValid2 = encoderSha.isPasswordValid("fdb58f7567972a13c2bedd11c6bac14f57f6b1d5", "test");
